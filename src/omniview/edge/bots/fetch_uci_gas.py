...
# The official UCI direct download URL for the AI4I 2020 Predictive Maintenance CSV
...
def main():
    ...
    dest_path = data_dir / "ai4i2020.csv"
    
    print(f"Downloading UCI AI4I 2020 Predictive Maintenance dataset from {UCI_URL}...")
